...
app.post('/analyze-skin', upload.single('image'), async (req, res) => {
    try {
        ...
        const promptText = `Sen profesyonel bir dermatologsun. 
            ...
            6. Doğal içerikler için model aşağıdaki maddelerden uygun olanları seçmelidir:
            - "Çay ağacı yağı"
            - "Aloe vera"
            - "Yeşil çay"
            - "Kil (kaolin, bentonit)"
            ...
            - "Avokado yağı"
            - "Bal"
            - "Doğal hyaluron türevleri"
            - "Yulaf özü"
            - "Centella Asiatica"
            - "Papatya, calendula"

            7. Kimyasal aktif içerikler için model aşağıdaki maddelerden uygun olanları seçmelidir:
            - "Salicylic Acid (BHA)"
            - "Niacinamide"
            - "Zinc PCA"
            - "Azelaic Acid (düşük doz)"
            - "Retinol (düşük doz)"
            - "AHA + BHA kombine tonikler"
            - "Benzoyl Peroxide (%2–5 düşük dozlar)"
            - "Hyaluronic Acid"
            - "Ceramides"
            - "Glycerin"
            - "Squalane"
            - "Peptidler"
            - "Lactic Acid (nazik AHA)"
            - "Panthenol"
            - "Madecassoside"

            8. Sabah rutini için model aşağıdaki adımlardan uygun olanları seçmeli ve her adım için kısa, içerik bazlı öneri yapmalıdır:
            ...
            9. Akşam rutini için model aşağıdaki adımlardan uygun olanları seçmeli ve kısa, içerik bazlı öneri yapmalıdır:
            ...
            10. Kullanılmaması gereken bir adım varsa, o adımı boş dizi olarak değil, hiç ekleme.

            11. Cevap tamamen Türkçe olmalıdır.
